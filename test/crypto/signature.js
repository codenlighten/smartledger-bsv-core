...
describe('Signature', function () {
  ...
  describe('#fromCompact', function () {
    ...
    it('should create a signature from an uncompressed signature', function () {
      ...
      const r = 'd5e61ab5bfd0d1450997894cb1a53e917f89d82eb43f06fa96f32c96e061aec1'
      const s = '2fc1188e8b0dc553a2588be2b5b68dbbd7f092894aa3397786e9c769c5348dc6'
  ...
  describe('#parseDER', function () {
    it('should parse this signature generated in node', function () {
      const sighex = '30450221008bab1f0a2ff2f9cb8992173d8ad73c229d31ea8e10b0f4d4ae1a0d8ed76021fa02200993a6ec81755b9111762fc2cf8e3ede73047515622792110867d12654275e72'
    ...
    it('reports sneg for a padded s', function () {
      ...
      const sighex = '304502203e4516da7253cf068effec6b95c41221c0cf3a8e6ccb8cbf1725b562e9afde2c' +
        '022100ab1e3da73d67e32045a20e0b999e049978ea8d6ee5480d485fcf2ce0d03b2ef0'
      const parsed = Signature.parseDER(Buffer.from(sighex, 'hex'))
  ...
  describe('#parseDER canonicality', function () {
    ...
    it('rejects a malleated re-encoding while the original still verifies', function () {
      ...
      const hashbuf = Hash.sha256(Buffer.from('der canonicality'))
      ...
      const canonical = function (nbuf) {
        return (nbuf[0] & 0x80) ? Buffer.concat([Buffer.from([0x00]), nbuf]) : nbuf
      }
      const padded = Buffer.concat([Buffer.from([0x00]), canonical(sig.r.toBuffer())])
      const sEnc = canonical(sig.s.toBuffer())
      const body = Buffer.concat([
        Buffer.from([0x02, padded.length]), padded,
        Buffer.from([0x02, sEnc.length]), sEnc
      ])
      const malleated = Buffer.concat([Buffer.from([0x30, body.length]), body])
