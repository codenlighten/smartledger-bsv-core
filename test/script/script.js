...
describe('Script', function () {
  ...
  describe('#toString', function () {
    ...
    it('should OP_1NEGATE opcode as -1 with ASM', function () {
      const script = Script.fromString('OP_1NEGATE')
  ...
  describe('#isDataOut', function () {
    ...
    it('validates that this 99994-byte OP_RETURN is a valid standard OP_RETURN', function () {
      const buf = Buffer.alloc(100000 - 6)
      buf.fill(0)
    ...
    it('validates that this 99995-byte OP_RETURN is a valid standard OP_RETURN', function () {
      const buf = Buffer.alloc(100000 - 5)
      buf.fill(0)
      Script(`OP_RETURN OP_PUSHDATA4 ${buf.length} 0x` + buf.toString('hex')).isDataOut().should.equal(true)
    })
  })
  ...
  describe('#isPublicKeyIn', function () {
    it('correctly identify scriptSig as a public key in', function () {
      ...
      // and input index: 5
      const scriptBuffer = Buffer.from('483045022050eb59c79435c051f45003d9f82865c8e4df5699d7722e77113ef8cadbd92109022100d4ab233e070070eb8e0e62e3d2d2eb9474a5bf135c9eda32755acb0875a6c20601', 'hex')
  ...
  describe('#buildPublicKeyHashOut', function () {
    ...
    it('should create script from public key', function () {
      const pubkey = new PublicKey('022df8750480ad5b26950b25c7ba79d3e37d75f640f8e5d9bcd5b150a0f85014da')
  ...
  describe('#buildDataOut', function () {
    ...
    it('should create script from array of some data', function () {
      const data = Buffer.from('bacacafe0102030405', 'hex')
      const s = Script.buildDataOut([data, data])
      should.exist(s)
    ...
    it('should create script from array of some datas', function () {
      const data1 = Buffer.from('moneybutton.com')
      const data2 = Buffer.from('hello'.repeat(100))
      const s = Script.buildDataOut([data1, data2])
      should.exist(s)
    ...
    it('should create script from array of lots of data', function () {
      const data1 = Buffer.from('moneybutton.com')
      const data2 = Buffer.from('00'.repeat(90000), 'hex')
      const s = Script.buildDataOut([data1, data2])
      should.exist(s)
    ...
    it('should create script from an array of hex strings', function () {
      const hexString = 'abcdef0123456789'
      const s = Script.buildDataOut([hexString, hexString], 'hex')
      should.exist(s)
  ...
  describe('#buildSafeDataOut', function () {
    it('should create script from no data', function () {
      const s = Script.buildSafeDataOut()
      should.exist(s)
    ...
    it('should create script from array of some data', function () {
      const data = Buffer.from('bacacafe0102030405', 'hex')
      const s = Script.buildSafeDataOut([data, data])
      should.exist(s)
    ...
    it('should create script from array of some datas', function () {
      const data1 = Buffer.from('moneybutton.com')
      const data2 = Buffer.from('hello'.repeat(100))
      const s = Script.buildSafeDataOut([data1, data2])
      should.exist(s)
    ...
    it('should create script from a hex string', function () {
      const hexString = 'abcdef0123456789'
      const s = Script.buildSafeDataOut(hexString, 'hex')
      should.exist(s)
    ...
    it('should create script from an array of hex strings', function () {
      const hexString = 'abcdef0123456789'
      const s = Script.buildSafeDataOut([hexString, hexString], 'hex')
      should.exist(s)
  ...
  describe('toAddress', function () {
    const pubkey = new PublicKey('027ffeb8c7795d529ee9cd96512d472cefe398a0597623438ac5d066a64af50072')
  ...
  describe('#getSignatureOperationsCount', function () {
    ...
    it('should handle P2SH-multisig-in scripts from utility', function () {
      ...
      const signature = bsv.crypto.Signature.fromString('3008020200FF020200FF')
