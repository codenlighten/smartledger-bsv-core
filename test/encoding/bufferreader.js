...
describe('BufferReader', function () {
  ...
  describe('readVarLengthBuffer', function () {
    it('returns correct buffer', function () {
      const buf = Buffer.from('73010000003766404f00000000b305434f00000000f203' +
  ...
  describe('#readUInt64LEBN', function () {
    ...
    it('should return 10 BSV', function () {
      const tenbsv = 10 * 1e8
      const tenbsvBuffer = Buffer.from('00ca9a3b00000000', 'hex')
      const br = new BufferReader(tenbsvBuffer)
  ...
  describe('#readVarintBuf', function () {
    ...
    it('should read a 9 byte varint', function () {
      const buf = BufferWriter().writeVarintBN(new BN(Math.pow(2, 54).toString())).concat()
      const br = new BufferReader(buf)
  ...
  describe('#readVarintNum', function () {
    ...
    it('should not throw an error on a 9 byte varint not over the javascript uint precision limit', function () {
      const buf = BufferWriter().writeVarintBN(new BN(Math.pow(2, 53).toString())).concat()
      const br = new BufferReader(buf);
      (function () {
        br.readVarintNum()
