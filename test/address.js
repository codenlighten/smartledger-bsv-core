...
describe('Address', function () {
  ...
  describe('validation', function () {
    it('getValidationError detects network mismatchs', function () {
      const error = Address.getValidationError('HC1hAdrx7APHg1DkE4bVLsZhY1SE5Dik1r', 'testnet')
      should.exist(error)
    })
  ...
  describe('encodings', function () {
    ...
    it('should make this address from an uncompressed pubkey', function () {
      const pubkey = new PublicKey('0485e9737a74c30a873f74df05124f2aa6f53042c2fc0a130d6cbd7d16b944b00' +
    ...
    describe('from a script', function () {
      ...
      it('should make this address from a p2pkh output script', function () {
        const s = new Script('OP_DUP OP_HASH160 20 ' +
      ...
      it('should make this address from a p2sh input script', function () {
        const s = Script.fromString('OP_HASH160 20 0xa6ed4af315271e657ee307828f54a4365fa5d20f OP_EQUAL')
        const a = Address.fromScript(s, 'livenet')
  ...
  describe('#inspect', function () {
    it('should output formatted output correctly', function () {
      const address = new Address(str)
      const output = '<Address: 16VZnHwRhwrExfeHFHGjwrgEMq8VcYPs9r, type: pubkeyhash, network: livenet>'
  ...
  describe('#fromPrivateKey', function () {
    ...
    it('should derive from public key testnet', function () {
      const privateKey = PrivateKey.fromRandom('testnet')
      const address = Address.fromPrivateKey(privateKey, 'testnet')
      ;(address.toString()[0] === 'm' || address.toString()[0] === 'n').should.equal(true)
    })
